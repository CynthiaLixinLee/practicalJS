///// VER 1 - FUNCTIONS
var todos = ['Groceries', 'Install curtains', 'Sort laundry']
...
//The '1' indicates that only one item is removed.
...
////// VER 2 - OBJECTS
var todoList = {
  todos: ['Groceries', 'Install curtains', 'Sort laundry'],
...
////// VER 3 - BOOLEANS
// Need to make every item on the list an object, with text and complete/incomplete properties
var todoList = {
  todos: [],
  displayToDos: function() {
    console.log('My Todos:', this.todos);
...
//    } else {
//      console.log('My Todos:');  //this.todos removed as it is now pointless
//      for (var i = 0; i < this.todos.length; i++){  // for loop to display todos
//        if (this.todos[i].completed === true) {
//          console.log('(x)', this.todos[i].todoText); //print with x
//        } else {
//          console.log('( )', this.todos[i].todoText); //print without x
//        }
//      }
//    }
//  },
